...
def face_detect(images,face_det_batch_size=16,pads=[0, 10, 0, 0],nosmooth=False):
...
def datagen(frames, mels,box=[-1,-1,-1,-1],static=False,img_size=96,wav2lip_batch_size=128):
...
def generateResult(face, audiopath, outfile, checkpoint_path, resize_factor=1, rotate=False, crop=(0, -1, 0, -1), fpss=25, wav2lip_batch_size=128, static=False):
	...
	gen = datagen(full_frames.copy(), mel_chunks,static=static)
